...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	{
		std::vector<glm::vec3> lVertexTemp;
		//vertex 1
		lVertexTemp.push_back(glm::vec3(-1.0f, -1.0f, 0.0f)); //position
		/*lVertexTemp.push_back(glm::vec3(1.0f, 0.0f, 0.0f));*/
		lVertexTemp.push_back(glm::vec3(1.0f, 1.0f, 1.0f) - lVertex.at(1)); //color
		//vertex 2
		lVertexTemp.push_back(glm::vec3(1.0f, -1.0f, 0.0f)); //position
		//lVertexTemp.push_back(glm::vec3(0.0f, 1.0f, 0.0f)); //color
		lVertexTemp.push_back(/*glm::vec3(1.0f, 1.0f, 1.0f) - */lVertex.at(3)); //color
		//vertex 3
		lVertexTemp.push_back(glm::vec3(0.0f, 1.0f, 0.0f)); //position
		//lVertexTemp.push_back(glm::vec3(0.0f, 0.0f, 1.0f)); //color
		lVertexTemp.push_back(/*glm::vec3(1.0f, 1.0f, 1.0f) - */lVertex.at(5)); //color
