...
void Application::Display(void)
{
	...
	static glm::quat myOrientation;
	myOrientation = glm::angleAxis(glm::radians(m_v3Rotation.x), AXIS_X)/* * myOrientation*/;
	myOrientation = glm::angleAxis(glm::radians(m_v3Rotation.y), AXIS_Y) * myOrientation;
	myOrientation = glm::angleAxis(glm::radians(m_v3Rotation.z), AXIS_Z) * myOrientation;

	m_pMesh->Render(m4Projection, m4View, ToMatrix4(/*m_m4Model*/myOrientation));
